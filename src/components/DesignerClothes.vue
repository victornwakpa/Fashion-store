<script setup>
    import { ref } from 'vue';
    import f from "../data/DesignerClothesData.json";

    const fashions = ref(f);
</script>

<template>
    <div class="py-16">
        <div class="text-center text-custom-primary">
            <h2 class="text-5xl font-medium">Designer Clothes For You</h2>
            <p class="py-5 text-lg">Immense yourself in the world of luxury fashion with our meeticulously crafted designer clothes!</p>
        </div>
