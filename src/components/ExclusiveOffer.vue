<template>
    <div class="min-h-screen grid place-content-center">
        <div class="hero-bg relative px-20 rounded-lg h-[30em] flex">
            <div class="flex-1">
            ...
            <div class="text-custom-primary flex-1 flex justify-center items-center">
                <div class="grid gap-6 text-center">
                    ...
                    <div class="md:my-6 flex gap-5">
                        ...
                        <div class="bg-white py-4 px-6">
                            <span class="text-3xl block font-bold">18</span>
                            <span class="text-md block font-medium">Hours</span>
                        </div>
                        <div class="bg-white py-4 px-6">
                            <span class="text-3xl block font-bold">48</span>
                            <span class="text-md block font-medium">Mins</span>
                        </div>
                    </div>
                    <button class="btn px-8 rounded-sm border-none btn-hero text-white">BUY NOW</button>
                </div>
